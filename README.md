...
Nous sommes tous concerné par rapport à l'intégrité des données. Car les données dont je parle, ce sont les votres. Aujourd’hui, la quasi-totalité des gens possèdent un outil numérique leur permettant d’accéder à Internet. Notamment un ordinateur. Cependant, ce que les gens ne savent pas, ou du moins, ne soupçonnent pas, c’est que dès le moment où ils se sont connectés à Internet, leur identité, et la moindre de leurs actions est enregistré, surveillé et contrôlé. Et cela permet d'établir sur eux, un profil numérique. On parle alors de "double numérique". Ce qui peut à la fois être une façon de la part des grandes groupes (comme n'importe lesquels bien sûr) de se faire de l'argent, en revendant ensuite ces précieuses données que les gens leurs transmettent sans soucis en acceptant tous ce qu'ils voient à l'écran, mais peut être aussi dans un autre cas, quelque chose de plus grave. Dans le sens où toutes leurs données peuvent être utilisés, un jour, contre eux.

Nous n’allons pas voir ici comment devenir 100% anonyme. Tout simplement car cela n’existe pas. Les gouvernements, disposant de ressources, d’outils et de temps nécessaire pourront un jour ou l’autre savoir. Non, ce qui compte ici, ce n’est pas de chercher l’anonymat parfait, car il n’existe pas, mais de limiter au maximum son empreinte, et leur emprise sur nous et nos données. Et, voir même, pour une protection vraiment avancée, de brouiller les pistes en adoptant les techniques d’OPsec pour les plus rigoureux. Mais ça c’est un sujet que l’on parlera dans un autre guide. Ici nous nous concentrerons uniquement sur la base des base.

Tout d’abord, comme indiqué, ce guide concernera avant tout la sécurité pour les gens qui sont sous Windows. Même si sécurité et intégrité rime davantage avec Linux, aujourd’hui, encore plus de deux tiers de la population ayant un ordinateur sont sous Windows. Nous allons voir alors en première partie la défense de vie privée pour notre OS, et ensuite en seconde partie, viendra la protection concernant les données que nous partageons sans le vouloir en ligne à travers nos navigateurs. Et cela, sera équivalent pour les autres OS, Linux comme MacOS (je me permets de prévoir ce que vont dire les puristes, oui je sais Linux n’est pas un OS à proprement parlé mais un noyau).

*« Mais pourquoi autant s’embêter ? Je n’ai rien à cacher. »* Snowden répondait alors à cette réflexion encore générale dans la tête de la plupart des gens ;
>*« Dire que votre droit à la vie privée ne vous importe pas parce que vous n'avez rien à cacher, c'est comme dire que votre droit à la liberte d'expression ne vous importe pas parce que vous n'avez rien à dire. »*
>
>Edward Snowden.

Cette phrase insouciante que pense encore beaucoup de personnes (malgré que la tendance commence progressivement à se faire voir) est parfaite pour illustrer à quel point ceux qui pensent qu'ils n'ont "rien à cacher" ne se soucient absolument du monde dans lequel ils vivent. Vivre en 2026 dans un monde qui est déjà hyper-connecté, et où nos identités, et plus globalement, nos vies, sont inscrites dans un univers numérique/informatique sans prendre conscience que cela peut être risqué, est un niveau de naïveté sans pareil. (Je parle bien de ceux qui le pense, pas ceux qui ne le savent pas. Ne voyez pas ici ma façon d'incriminer des personnes dont le monde numérique n'est pas leur univers bien entendu). Ici, ce n’est même pas question de savoir si vous avez fait quelque chose de mal ou de répréhensible aux yeux de la loi, c’est de comprendre que vous êtes surveillé, espionné à votre insu. Et on ne parle pas là uniquement des petits hackers indépendants. Non, je parle bien par nos gouvernements.
>Rien n’est sans rappeler l’affaire en 2013 avec Snowden, ou encore avec Julian Assange pour ne citer qu’eux, de l’exposition de la surveillance de masse qu’organisaient les services secrets américains. Il a fallu tout de même qu'un ancien analyste de la NSA mettent sa vie en danger pour nous avertir. Je pense que ce sacrifice est à prendre très au sérieux pour nous tous.

Ce qu’il faut savoir, c’est que la capacité de stockage de données des systèmes de surveillance de masses augmente chaque année. Et on ne peut pas imaginer la quantité de data qui est stocker dans ces centres de données. C'est absolument dementiel.
Aussi, ce qu'il faut avoir en tête, c'est que vous n’avez pas besoin d’avoir fait quelque chose de mal. Il suffit juste qu’un jour, quelqu’un finisse par vous soupçonner, peut importe comment, et qu’ils *[les agences de renseignement gouvernementales]* utilisent leur système pour « remonter le temps » et examiner chacune de vos décisions, chaque ami avec qui vous avez discuté, chaque discussions, photos, mails, déplacement que vous avez fait au cours du temps, et d’ensuite vous attaquer sur cette base pour éveiller les soupçons. Et faire in fine passer une personne, à priori innocente, en un malfaiteur. Ils le font pour les lanceurs d'alertes, les journalistes et certains avocats. Si ces corps de métiers sont si ciblés ce n'est pas pour rien. Imaginez si demain votre pays tombe sous un régime autoritaire (coucou les USA...), qu'en sera-t-il de votre si chère liberté d'expression ? De votre droit à la contestation ? De votre vie privée en général ?

Alors, il ne vas pas être question ici de vous rendre paranoïaque, (même s'il y a de quoi) et de vous donner les clés d'une sécurité de votre vie privée du plus haut niveau. Non, ici l'objectif sera d'établir des maneuvres et configurations (notamment sur Windows car la plupart d'entre vous le sont dessus) afin que la protection de vos données personnelles soit davantage au cœur de vos préocupations.
